...
class CampaignMetaDataServletTest {

    private CampaignMetaDataServlet fixture = new CampaignMetaDataServlet();
    ...
    void doGet(AemContext context) throws ServletException, IOException {
        ...
        assertEquals("Title = resource title", "Title = resource title");
    }
}
